...
def create_parser():
    ...
    # Dataset
    parser.add_argument('--dataset', '-data', type=str, default='cifar', help='which dataset / options [mnist, fmnist, cifar]')
    ...
    parser.add_argument('--num_active', '-a',  default=64, type=int, help='size for the active set of the SASGP')
    parser.add_argument('--dtype', type=int, default=32, help='which precision / [32, 64]')     

    # Kernel initialisation   
    parser.add_argument('--sigma', '-sn', default=1., type=float, help='likelihood noise')
    parser.add_argument('--kernel_ls', '-ls', default=0.1, type=float, help='lengthscale of the RBF kernel')
    parser.add_argument('--kernel_a', '-am', default=0.1, type=float, help='amplitude of the RBF kernel')
    ...
    parser.add_argument('--plot', type=str2bool, default='yes', help='plot training figure? -- [yes, no, false, true]')
    parser.add_argument('--save', '-s', type=str2bool, default=True, help='do we save results? [true, false]')
